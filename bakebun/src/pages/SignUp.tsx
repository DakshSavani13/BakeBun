  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 10 }}>
      <Box sx={{
        ...
        inset: 0,
        zIndex: -1,
        background: 'radial-gradient(700px 300px at 15% 0%, rgba(255,184,0,0.25) 0%, rgba(255,184,0,0) 60%), radial-gradient(700px 300px at 85% 100%, rgba(255,75,43,0.2) 0%, rgba(255,75,43,0) 60%)'
      }} />
      <Paper elevation={3} sx={{ p: 4, borderRadius: 3, backdropFilter: 'blur(6px)' }}>
        ...
        <Box component="form" onSubmit={handleSignUp}>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}>
            <Button variant="outlined" fullWidth sx={{ borderRadius: 2 }}>Sign up with Google</Button>
            <Button variant="outlined" fullWidth sx={{ borderRadius: 2 }}>Sign up with Facebook</Button>
          </Stack>
        </Box>
      </Paper>
    </Container>
